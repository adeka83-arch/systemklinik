...
export function FieldTripReport({ accessToken, filters, onPrint }: FieldTripReportProps) {
  ...
  const calculateFieldTripFeesAndBonuses = () => {
    ...
    // Get raw field trip sales data from server
    fieldTripSalesData.forEach(sale => {
      // Get actual raw data from server (need to fetch from sales endpoint)
  ...
  return (
    <Card className="border-pink-200">
      ...
      <CardContent>
        ...
        {/* Fee Summary for Field Trip - Updated with Actual Data */}
        <div className="mt-4 p-4 bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="text-center">
              ...
              <div className="text-sm text-yellow-700">Total Fee Dokter</div>
            </div>
            <div className="text-center">
              <div className="text-xl font-bold text-green-600">
                {formatCurrency(totalEmployeeBonuses)}
              </div>
              <div className="text-sm text-green-700">Total Bonus Karyawan</div>
            </div>
            <div className="text-center">
