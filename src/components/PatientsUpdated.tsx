...
export default function PatientsUpdated({ accessToken }: PatientsProps) {
            ...
            <Dialog open={scheduleDialogOpen} onOpenChange={setScheduleDialogOpen}>
              ...
              <DialogContent className="large-dialog max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Buat jadwal kontrol untuk pasien - Cari dan pilih pasien dari tabel di bawah
                  </DialogDescription>
                </DialogHeader>
                    ...
                    <div className="space-y-3">
                      ...
                      {scheduleForm.patientId && (
                        <div className="mt-3 p-3 bg-pink-50 border border-pink-200 rounded-lg">
                          <div className="flex items-center justify-between">
                            <div>
                              <span className="text-sm font-medium text-pink-800">Pasien Terpilih:</span>
                              <div className="mt-1">
                                {(() => {
                                  const selectedPatient = patients.find(p => p.id === scheduleForm.patientId)
