...
import { Plus, Edit, Trash2, Clock, ArrowDown, Settings, User } from 'lucide-react'
        ...
        <CardContent>
          <Tabs defaultValue="data" className="w-full">
            ...
            <TabsContent value="settings" className="mt-6">
              <div className="mb-4">
                <p className="text-sm text-pink-600">
                  Atur nominal default uang duduk per dokter dan shift untuk mempermudah input data
                </p>
              </div>
              <div className="overflow-x-auto">
                <Table>
                ...
                {sittingFeeSettings.length === 0 && (
                  <div className="text-center py-8 text-pink-600">
                    Belum ada pengaturan default. Klik "Atur Default" untuk menambahkan.
                  </div>
                )}
              </div>
            </TabsContent>
      ...
      <Card className="border-pink-200 bg-pink-50">
        <CardContent className="p-6">
          <div className="space-y-4">
            <div>
              <h3 className="text-pink-800 font-semibold flex items-center gap-2">
                <Settings className="h-4 w-4" />
                Sistem Otomatisasi Uang Duduk:
              </h3>
              <ul className="text-pink-700 text-sm space-y-1 mt-2">
                <li>• Uang duduk otomatis tersimpan saat dokter absen masuk shift</li>
                <li>• Nominal diambil dari pengaturan default yang sudah diatur</li>
                <li>• Tombol tambah manual dihapus untuk menghindari duplikasi</li>
                <li>• Atur nominal default per dokter dan shift di tab "Pengaturan Default"</li>
                <li>• Edit atau hapus data uang duduk yang sudah tersimpan jika diperlukan</li>
              </ul>
            </div>
            
            <div>
              <h3 className="text-pink-800 font-semibold">Aturan Perhitungan Uang Duduk:</h3>
              <ul className="text-pink-700 text-sm space-y-1">
                <li>• Jika ada tindakan, uang duduk akan hilang</li>
                <li>• Jika tidak ada tindakan, dokter mendapat uang duduk penuh</li>
                <li>• Jika fee tindakan dalam satu shift lebih kecil dari uang duduk, maka fee dokter = uang duduk</li>
                <li>• Jika fee tindakan lebih besar dari uang duduk, dokter mendapat fee tindakan penuh</li>
              </ul>
            </div>
          </div>
        </CardContent>
