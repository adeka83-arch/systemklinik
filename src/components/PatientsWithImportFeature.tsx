...
function PatientsWithImportFeature({ accessToken }: PatientsProps) {
                    ...
                    {filteredPatients.length === 0 ? (
                      ...
                      filteredPatients.map((patient) => (
                        <TableRow key={patient.id}>
                          ...
                          <TableCell>
                            {patient.birthDate ? `${calculateAge(patient.birthDate)} th` : '-'}
                          </TableCell>
...
export default PatientsWithImportFeature